...
(function ($) {
    $.extend({
        ...
        operate: {
            ...
            remove: function(id) {
                table.set();
                $.modal.confirm("Are you sure to delete this item " + table.options.modalName + " message？", function() {
            ...
            removeAll: function() {
                ...
                $.modal.confirm("Confirm to delete the selected " + rows.length + " data?", function() {
            ...
            editTab: function(id) {
                table.set();
                $.modal.openTab("edit " + table.options.modalName, $.operate.editUrl(id));
            },
            // 修改信息 全屏
