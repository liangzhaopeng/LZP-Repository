...
class _GaodeMapPageState extends State<GaodeMapPage> {
  ...
  //点击地图后显示地理位置;
   void _onPoiTouched(AMapPoi poi) {
     ...
     EasyLoading.showToast("Your location distance here is${_calcDistance(currentLocation!.target.latitude, currentLocation!.target.longitude, poi.latLng!.latitude, poi.latLng!.longitude)} 米");
     //add maker;
   ...
   void _add(double latitude, double longitude,String localName) {
     ...
     final Marker marker = Marker(
       ...
       infoWindow: InfoWindow(title: 'The geographical location you clicked is:$localName'),
