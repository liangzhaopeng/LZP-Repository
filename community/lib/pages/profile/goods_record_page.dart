...
class GoodsRecordPage extends StatefulWidget {
  static const routeName = "/goodsrecord";
  const GoodsRecordPage({Key? key}) : super(key: key);

  @override
  State<GoodsRecordPage> createState() => _GoodsRecordPageState();
}

class _GoodsRecordPageState extends State<GoodsRecordPage> {
  List<Goods> items = [];
  ...
  getSecondGoods() {
    ...
    HTTPRqeust.request("second/list",method: "post", params: params).then((value) {
      if (value['code'] == 0) {
